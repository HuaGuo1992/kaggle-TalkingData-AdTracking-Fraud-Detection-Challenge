...
def DO(frm,to,fileno):
    ...
    if debug:
        ...
        test_df = pd.read_csv(inputpath+"test.csv", parse_dates=['click_time'], dtype=dtypes, usecols=['ip','app','device','os', 'channel', 'click_time', 'click_id'])
...
if debug:
    ...
    val_size = 25000000
    # nchunk = 40000000
    nchunk = 180000000 #from 78000000
    frm = nrows - nchunk
