...
def DO(train_frm,train_to, test_nrows, groups, fileno):
    dtypes = {
            'ip'            : 'uint32',
            'app'           : 'uint16',
            'device'        : 'uint16',
...
for group, fileno in zip(groups, filenos):
    sub=DO(frm,to,test_nrows, group, fileno)
